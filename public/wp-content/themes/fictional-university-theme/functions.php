...
{
    $api['key'] = 'AIzaSyDUjy9d3alg3hawhOb4UK3212nJiDPgCTY';
    return $api;
}

add_filter('acf/fields/google_map/api', 'universityMapKey');

// Redirect subscripber accounts out of admin and onto homepage
...
// Filtering the post limit for each user.
